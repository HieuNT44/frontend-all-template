---
This file defines commit message conventions for this project.
AI assistants should follow these rules when generating commits.
---
...
- _Optionally_ reference issue identifiers (e.g., `Closes #123`, `Fixes Redmine-456`)
