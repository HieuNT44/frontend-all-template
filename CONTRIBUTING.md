# Contributing to TOMOSIA FRONTEND

Thanks for showing interest in improving **TOMOSIA FRONTEND**.  
...
For a detailed example of this setup, see the [Feature-Based Pattern Documentation](../docs/en/01-feature-base-pattern.md).
...
- Lefthook Git hooks are enabled - linting and formatting run automatically when you commit, and if there are errors the commit will be blocked until they are fixed.
...
- Report bugs, suggestions, or issues via GitHub Issues
